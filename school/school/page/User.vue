    ...
    <div id="wrapper">
        ...
        <div class="main_sidebar">
            ...
            <div class="sidebar-header">
                <!-- Logo-->
                <div id="logo">
                    <a href="feeds.html"> <img src="assets/images/logo-light.png" alt="" class="logo-light"></a>
                </div>
                ...
                <div class="sidebar_innr" data-simplebar>
                    ...
                    <div class="sections">
                        ...
                        <a href="#" class="button secondary px-5 btn-more" uk-toggle="target: #more-veiw; animation: uk-animation-fade">
                            <span id="more-veiw">查看 更多 <i class="icon-feather-chevron-down ml-2"></i></span>
                            <span id="more-veiw" hidden>收 起<i class="icon-feather-chevron-up ml-2"></i> </span>
                        </a>
                    </div>
                    ...
                    <div id="foot">
                        ...
                        <ul>
                            <li> <a href="page-term.html"> 关于 我们 </a></li>
                            <li> <a href="page-setting.html"> 设置 </a></li>
                            <li> <a href="page-privacy.html"> 隐私 政策 </a></li>
                            <li> <a href="page-term.html"> 条款 </a></li>
                        </ul>


                        <div class="foot-content">
                            <p>© 2020 <strong>广州理工学院</strong>. 版权所有. </p>
                        </div>
                ...
                <header>
                    <div class="header-innr">
                        ...
                        <div id="logo">
                            ...
                            <a href="feeds.html"> <img src="assets/images/logo-light.png" class="logo-inverse" alt=""></a>
                        </div>
                        ...
                        <div class="head_search">
                            <form>
                                <div class="head_search_cont">
                                    <input value="" type="text" class="form-control" placeholder="搜索好友，视频，更多内容.." autocomplete="off">
                                    ...
                                    <ul class="dropdown-search-list">
                                        ...
                                        <li>
                                            <a href="#">
                                                ...
                                                <p> Mountain Riders <span> 3 days ago <span>Group</span> </span>
                                                </p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                ...
                                                <p> Coffee Addicts <span> 12 days ago <span> Page</span></span>
                                                </p>
                                            </a>
                                        </li>
                                        <li class="menu-divider"></li>
                                        <li class="list-footer"> <a href="your-history.html"> 历史搜索 </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="head_user">
                            ...
                            <!-- browse apps  -->
                            <a href="#" class="opts_icon uk-visible@s" uk-tooltip="title: 创建 ; pos: bottom ;offset:7">
                            ...
                            <a href="#" class="opts_icon" uk-tooltip="title: 信息 ; pos: bottom ;offset:7">
                            ...
                            <div uk-dropdown="mode:click ; animation: uk-animation-slide-bottom-small" class="dropdown-notifications display-hidden">
                                ...
                                <div class="dropdown-notifications-content" data-simplebar>
                                    ...
                                    <div class="dropdown-notifications-headline">
                                        <h4>信息</h4>
                                        <a href="#">
                                            <i class="icon-feather-settings" uk-tooltip="title: 信息 设置 ; pos: left"></i>
                                        </a>
                                    </div>
                            ...
                            <div uk-dropdown="mode:click ; animation: uk-animation-slide-bottom-small" class="dropdown-notifications display-hidden">
                                ...
                                <div class="dropdown-notifications-content" data-simplebar>
                                    ...
                                    <div class="dropdown-notifications-headline">
                                        <h4>通知 </h4>
                                        <a href="#">
                                            <i class="icon-feather-settings" uk-tooltip="title: 通知 设置 ; pos: left"></i>
                                        </a>
                                    </div>
                            ...
                            <div uk-dropdown="mode:click ; animation: uk-animation-slide-bottom-small" class="dropdown-notifications rounded display-hidden">
                                ...
                                <a href="timeline.html">
                                    ...
                                    <div class="dropdown-user-details">
                                        ...
                                        <div class="dropdown-user-name"> 王 利 </div>
                                    </div>
                                ...
                                <ul class="dropdown-user-menu">
                                    <li>
                                        <a href="#"> <i class="fas fa-rocket"></i> 推送邮件 </a>
                                    </li>
                                    <li>
                                        <a href="#"> <i class="fas fa-rocket"></i> 推送页面 </a>
                                    </li>
                                    <li>
                                        <a href="#"> <i class="fas fa-bullhorn"></i> 公告 </a>
                                    </li>
                                    <li>
                                        <a href="#"> <i class="fas fa-user-edit"></i> 通用设置</a>
                                    </li>
                                    <li>
                                        <a href="#"> <i class="fas fa-user-cog"></i> 个人中心</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="form-login.html"> <i class="fas fa-sign-out-alt"></i>注销</a>
                                    </li>
                                </ul>
                                ...
                                <ul class="dropdown-user-menu">
                                    <li>
                                        <a href="page-setting.html" class="bg-secondery"> <i class="uil-bolt"></i>
                                            <div> 赞助 我们 <span> 您的支持将会是我们最大的动力 </span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
            ...
            <div class="main_content_inner">
                ...
                <div class="profile">
                    <div class="profile-cover">
                        ...
                        <a href="#"> <i class="uil-camera"></i> 编辑 </a>
                    ...
                    <div class="nav-profile" uk-sticky="media : @s">
                        <div class="py-md-2 uk-flex-last">
                            <a href="#" class="button primary mr-2"> <i class="uil-plus"></i> 书写你的故事</a>
                        ...
                        <div>
                            <nav class="responsive-tab ml-lg-3">
                                <ul>
                                    ...
                                    <li><a href="timeline-friends.html">关于</a></li>
                                    <li><a href="timeline-friends.html">朋友</a></li>
                                    <li><a href="timeline-friends.html">图片</a></li>
                                    <li><a href="timeline-friends.html">视频</a></li>
                                </ul>
                            </nav>
                            <div class="uk-visible@s">
                                <a href="#" class="nav-btn-more">更多</a>
                                <!-- 修改 -->
                ...
                <div class="section-small">
                    ...
                    <div uk-grid>
                        ...
                        <div class="uk-width-2-3@m fead-area">
                                ...
                                <div class="post-new" uk-toggle="target: body ; cls: post-focus">
                                    <div class="post-new-media">
                                        ...
                                        <div class="post-new-media-input">
                                            <input type="text" class="uk-input" placeholder="你有什么想法？">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="post-new-type">
                                        ...
                                        <a href="#">
                                            <img src="assets/images/icons/live.png" alt=""> 录像
                                        </a>

                                        <a href="#">
                                            <img src="assets/images/icons/photo.png" alt=""> 图片
                                        </a>

                                        <a href="#" class="uk-visible@s">
                                            <img src="assets/images/icons/tag-friend.png" alt=""> 社团
                                        </a>

                                        <a href="#"><img src="assets/images/icons/reactions_wow.png" alt=""> 兴趣
                                        </a>
                            ...
                            <div class="post">
                                <div class="post-heading">
                                    ...
                                    <div class="post-btn-action">
                                        ...
                                        <div class="mt-0 p-2" uk-dropdown="pos: top-right;mode:hover ">
                                            <ul class="uk-nav uk-dropdown-nav">
                                                <li>
                                                    <a href="#"> <i class="uil-share-alt mr-1"></i> 分享</a>
                                                </li>
                                                <li>
                                                    <a href="#"> <i class="uil-edit-alt mr-1"></i> 编辑动态 </a>
                                                </li>
                                                <li>
                                                    <a href="#"> <i class="uil-comment-slash mr-1"></i> 删除评论
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"> <i class="uil-favorite mr-1"></i> 添加到我最喜欢的 </a>
                                                </li>
                                                <li>
                                                    <a href="#" class="text-danger"> <i class="uil-trash-alt mr-1"></i> 删除 </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="post-state">
                                    <!-- 这个数据是写死的  我们要写成动态 -->
                                    <div class="post-state-btns"> <i class="uil-thumbs-up"></i> 126<span> 点赞 </span>
                                    </div>
                                    <div class="post-state-btns"> <i class="uil-heart"></i> 18 <span> 喜欢</span>
                                    </div>
                                    <div class="post-state-btns"> <i class="uil-share-alt"></i> 193 <span> 分享
                                        </span>
                                    </div>
                                    <div class="post-state-btns"> <i class="uil-bookmark"></i> 13 <span> 收藏  </span>
                                    </div>
                                </div>

                                <!-- post comments -->
                                <div class="post-comments">
                                    <a href="#" class="view-more-comment"> 查看8个或更多的评论</a>
                                    ...
                                    <div class="post-comments-single">
                                        ...
                                        <div class="post-comment-text">
                                            ...
                                            <div class="uk-text-small">
                                                <!-- 加粗  -->
                                                <a href="#" class="text-primary mr-1"> <i class="uil-thumbs-up"></i> 喜欢
                                                </a>
                                                <a href="#" class=" mr-1"> Replay </a>
                                                <span> 2天前</span>
                                            </div>
                                    ...
                                    <a href="#" class="view-more-comment">查看更多之前的评论</a>
                            ...
                            <div class="post">
                                <div class="post-heading">
                                    ...
                                    <div class="post-title">
                                        <h4> 第二个人的动态 模块 </h4>
                                        <p> 5 <span> 小时前 </span> <i class="uil-users-alt"></i> </p>
                                    </div>
                                    <div class="post-btn-action">
                                        <!-- .....更多的按钮 -->
                                        <span class="icon-more uil-ellipsis-h"></span>
                                ...
                                <div class="post-description">
                                    ...
                                    <div class="post-state-details">
                                        ...
                                        <p> <span class="mr-2"> <i class="uil-eye"></i> 11个人看过 </span> 212 评论 </p>
                                    </div>
                                </div>

                                <div class="post-state">
                                    <!-- 这个数据是写死的  我们要写成动态 -->
                                    <div class="post-state-btns"> <i class="uil-thumbs-up"></i> 133 <span> 点赞 </span>
                                    </div>
                                    <div class="post-state-btns"> <i class="uil-heart"></i> 11 <span> 喜欢</span>
                                    </div>
                                    <div class="post-state-btns"> <i class="uil-share-alt"></i> 23 <span> 分享
                                        </span>
                                    </div>
                                    <div class="post-state-btns"> <i class="uil-bookmark"></i> 14 <span> 收藏  </span>
                                    </div>
                                </div>
                                ...
                                <div class="post-comments">
                                    ...
                                    <div class="post-comments-single">
                                        ...
                                        <div class="post-comment-text">
                                            ...
                                            <div class="uk-text-small">
                                                <a href="#" class="text-danger mr-1"> <i class="uil-heart"></i> 喜欢
                                                </a>
                                                <a href="#" class=" mr-1"> Replay </a>
                                                <span> 3天前</span>
                                            </div>
                                    ...
                                    <div class="post-comments-single">
                                        ...
                                        <div class="post-comment-text">
                                            ...
                                            <div class="uk-text-small">
                                                <a href="#" class="text-primary mr-1"> <i class="uil-thumbs-up"></i> 点赞
                                                </a>
                                                <a href="#" class=" mr-1"> Replay </a>
                                                <span> 3天前</span>
                                            </div>
                            ...
                            <div class="post">
                                ...
                                <div class="post-description">
                                    ...
                                    <div class="post-state-details">
                                        ...
                                        <p> <span class="mr-2"> <i class="uil-eye"></i> 38个人看过 </span> 21个评论
                                        </p>
                                    </div>
                                ...
                                <div class="post-comments">
                                    ...
                                    <div class="post-comments-single">
                                        ...
                                        <div class="post-comment-text">
                                            <div class="post-comment-text-inner">
                                                <h6>Stella Johnson</h6>
                                                <p> 1111111111===== <strong> David !</strong> </p>
                                            </div>
                                            <div class="uk-text-small">
                                                <a href="#" class="text-primary mr-1"> <i class="uil-thumbs-up"></i> 点赞
                                                </a>
                        ...
                        <div class="uk-width-expand">
                            <!-- 最右边功能内容  -->
                            <div class="sl_sidebar_sugs_title border-0"> 话题讨论
                                <i class="icon-feather-rotate-cw"></i>
                                <!-- 刷新标签按钮 没有实现  -->
                            </div>
                            <div class="list-group-item sl_htag">
                                <a href="#">
                                    <span class="htag_top"> #肖战偷袭马保国</span>
                                </a>
                            </div>
                            <div class="list-group-item sl_htag">
                                <a href="#">
                                    <span class="htag_top"> #大四毕业|毕业设计</span>
                                </a>
                            </div>
                            <div class="list-group-item sl_htag">
                                <a href="#">
                                    <span class="htag_top"> #期末考试|挂科</span>
                                </a>
                            </div>
                            <div class="list-group-item sl_htag">
                                <a href="#">
                                    <span class="htag_top">#校招|工作指南</span>
                                </a>
                            </div>
                            <div class="list-group-item sl_htag">
                                <a href="#">
                                    <span class="htag_top"> #Gz理工</span>
                                </a>
                            </div>
                            <div class="list-group-item sl_htag">
                                <a href="#">
                                    <span class="htag_top">#最新</span>
                                </a>
                            </div>

                            <div class="sl_sidebar_sugs_title mt-4">优秀毕业生
                                <i class="icon-feather-rotate-cw"></i>
                                <!-- 刷新标签按钮 没有实现  -->
                            </div>
                            <div class="uk-position-relative" uk-slider="finite: true; autoplay:true">
                                ...
                                <div class="uk-slider-container pb-3">
                                    ...
                                    <a class="uk-position-center-right-out uk-position-small uk-hidden-hover slidenav-next sl_pro_users_next" href="#" uk-slider-item="next"></a>

                                </div>
                            </div>

                            <div class="sl_sidebar_sugs_title">你可能想了解的人
                                <i class="icon-feather-rotate-cw"></i>
                            </div>
                            <div class="sl_sidebar_sugs">
                                ...
                                <div class="sl_sidebar_sugs_text">
                                    <a href="#" class="sl_user_link_name"> 王利 </a>
                                </div>
                            ...
                            <div class="sl_sidebar_sugs">
                                ...
                                <div class="sl_sidebar_sugs_text">
                                    <a href="#" class="sl_user_link_name"> 未关注改为蓝色吧 </a>
                                </div>
                                <!--   按钮颜色不对吧  关注了的应该变成灰色  未关注改为蓝色吧?????? -->
                                <div class="user-follow-button sl_sidebar_sugs_btns">
                                    <button type="button" class="button small">
                                        <span> 关注了的应该变成灰色 </span>
                                    </button>
                                </div>
                            </div>

                            <div class="sl_sidebar_sugs_title mt-4">你可能会喜欢的内容 不清楚
                                <i class="icon-feather-rotate-cw"></i>
                            </div>
                            <div class="sl_sidebar_sugs">
                                <div class="sl_sidebar_sugs_avatar">
                                ...
                                <div class="sl_sidebar_sugs_text">
                                    <a href="#" class="sl_user_link_name"> 学习计划 </a>
                                    <span> 教育 </span>
                                </div>
                                <div class="user-follow-button sl_sidebar_sugs_btns">
                                    <button type="button" class="button small">
                            ...
                            <div class="sl_sidebar_sugs">
                                ...
                                <div class="sl_sidebar_sugs_text">
                                    <a href="#" class="sl_user_link_name"> 如何找到知己 </a>
                                    <span> 社交 </span>
                                </div>
                                <div class="user-follow-button sl_sidebar_sugs_btns">
                                    <button type="button" class="button small">
                            ...
                            <div class="sl_sidebar_sugs_title mt-4">加入小组
                                <i class="icon-feather-rotate-cw"></i>
                            </div>
                            <div class="sl_sidebar_sugs">
                                <div class="sl_sidebar_sugs_avatar">
                                ...
                                <div class="sl_sidebar_sugs_text">
                                    <a href="#" class="sl_user_link_name"> 肖战绝对要死 </a>
                                    <span> 12亿+</span>
                                </div>
                                <div class="user-follow-button sl_sidebar_sugs_btns">
                                    <button type="button" class="button small">
                            ...
                            <div class="sl_sidebar_sugs">
                                ...
                                <div class="sl_sidebar_sugs_text">
                                    <a href="#" class="sl_user_link_name"> 马保国复仇肖战 </a>
                                    <span> 6000万+</span>
                                </div>
                                <div class="user-follow-button sl_sidebar_sugs_btns">
                                    <button type="button" class="button small">
                            ...
                            <div class="sl_sidebar_sugs">
                                ...
                                <div class="sl_sidebar_sugs_text">
                                    <a href="#" class="sl_user_link_name"> 没有加入小组改为蓝色</a>
                                    <span> 32</span>
                                </div>
                                <div class="user-follow-button sl_sidebar_sugs_btns">
                                    <button type="button" class="button small">
                            ...
                            <div class="sl_sidebar_sugs">
                                ...
                                <div class="sl_sidebar_sugs_text">
                                    <a href="#" class="sl_user_link_name"> 加入后改为灰色 取消加入 </a>
                                    <span> 25 </span>
                                </div>
                                <div class="user-follow-button sl_sidebar_sugs_btns">
                                    <button type="button" class="button small">
                            ...
                            <div class="sl_sidebar_sugs_title mt-4">在线用户
                            </div>

                            <div class="sl_sidebar_sugs_title mt-1"> 邀请你的朋友
                                <i class="icon-feather-rotate-cw"></i>
                            </div>
                            ...
                            <div class="footer-wrapper-sidebar mt-4">
                                ...
                                <ul class="list-inline">
                                    <li><a href="#">关于</a></li>
                                    <li><a href="www.thxy.com">学院官网</a></li>
                                    <li><a href="#"> 隐私</a></li>
                                    <li><a href="#">联系我们</a></li>
                                    <li><a href="#">开发者们</a></li>
                                    <li>
                                        <div class="dropdown dropup sun_foot_drop_menu">
                                            ...
                                            <div uk-dropdown="pos: bottom-left ; mode:hover " class="uk-dropdown uk-dropdown-bottom-right" style="left: 745px; top: 87px;">
                                                <ul class="uk-nav uk-dropdown-nav">
                                                    <li><a href="#"> 作为游客访问  </a></li>
                                                    <li><a href="#"> 提出改进意见 </a></li>
                                                    <li><a href="#"> 举报违规</a></li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <div class="uk-offcanvas-bar">
                    ...
                    <div class="sidebar-chat-head mb-2">
                        ...
                        <div class="btn-actions">
                            <a href="#" uk-tooltip="title: 搜索 ;offset:7" uk-toggle="target: .sidebar-chat-search; animation: uk-animation-slide-top-small"> <i class="icon-feather-search"></i> </a>
                            <a href="#" uk-tooltip="title: 设置 ;offset:7"> <i class="icon-feather-settings"></i> </a>
                    ...
                    <div class="sidebar-chat-search" hidden>
                        <input type="text" class="uk-input" placeholder="查找 消息">
